...
describe 'Song' do
  ...
  describe 'class variables' do
    ...
    it 'has a class variable, @@artists, that contains all of the
        artists of existing songs' do
      expect(Song.class_variable_get(:@@artists)).to match(['Jay-Z',
                                                            'Jay-Z',
                                                            'Brittany Spears'])
    end

    it 'has a class variable, @@genres, that contains all
        of the genres of existing songs' do
  ...
  describe '.artists' do
    it 'is a class method that returns a unique array of artists of
        existing songs' do
  ...
  describe '.genres' do
    it 'is a class method that returns a unique array of genres
        of existing songs' do
      expect(Song.genres).to match(%w[rap pop])
    end
  end

  describe '.genre_count' do
    it 'is a class method that returns a hash of genres
        and the number of songs that have those genres' do
      expect(Song.genre_count).to eq('pop' => 1, 'rap' => 2)
    end
  end

  describe '.artist_count' do
    it 'is a class method that returns a hash of artists
        and the number of songs that have those artists' do
